...
namespace MShare.Framework.Types.Addresses
{
	...
	{
		private static Dictionary<string, string> _contryCodes = new Dictionary<string, string>() {
		   { "AFG", "AF" },    // Afghanistan
		   { "ALB", "AL" },    // Albania
		   { "ARE", "AE" },    // U.A.E.
		   { "ARG", "AR" },    // Argentina
		...
		public static CountryCode2 To2(CountryCode3 countryCode3)
		{
			var code = _contryCodes[countryCode3.Code];
			return code;
		}
	}
}
